...
import {
  ...
  getMedicalProblemDetails,
  getMedicalProblemsList,
  updateMedicalProblem,
} from "../thunks/medical-problems-thunk";
...
const medicalProblemsSlice = createSlice({
  ...
  reducers: {
    ...
    setCurrentMedicalProblem(
      state,
      action: { payload: MedicalProblemsInterface; type: string }
    ) {
  ...
  extraReducers(builder) {
    ...
    builder.addCase(getMedicalProblemsList?.fulfilled, (state, action) => {
      state.loading = false;
      state.medicalProblems = action.payload;
      state.error = "";
    ...
    builder.addCase(createMedicalProblem.fulfilled, (state, _action) => {
      state.loading = false;
      state.currentMedicalProblem = initialState.currentMedicalProblem;
      state.medicalProblems = PaginatedListModel.resetPaginatedList(
        state.medicalProblems
      );
      state.error = "";
