...
import { createSurgery, deleteSurgery, getSurgeriesList, getSurgeryDetails, updateSurgery } from "../thunks/surgeries-thunk";
...
const surgeriesSlice = createSlice({
    ...
    reducers: {
        ...
        setCurrentSurgery(state, action: { payload: SurgeriesInterface, type: string }) {
            state.currentSurgery = action.payload;
        },
        setSurgeryList(state, action: { payload: SurgeriesInterface[], type: string }) {
