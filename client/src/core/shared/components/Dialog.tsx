...
const Dialog = ({display,DialogStateController,title,children} : CustomizeDialogProps) => {
  return (
        ...
        <Box sx={{padding:'2rem', position:'fixed',top:'0', left:'0', width:'100%', height:'100%', zIndex:'1001'}}>
            <Box sx={{position:'relative', backgroundColor:'white', width:'100%', height:'100%', borderRadius:'15px', }}>
                <Box sx={{
                  ...
                  <CloseRoundedIcon sx={{color:'white',margin:'0.5rem', fontSize:'2rem', cursor:'pointer'}} onClick={()=> DialogStateController('none')}/>
