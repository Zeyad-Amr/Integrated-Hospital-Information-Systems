...
const Tabs = ({ Tabs }: TabsProps) => {
    ...
    return (
        <Box>
            <Box sx={{ display: 'flex', width: '90%',  margin: '0rem auto' }}>
                {
            ...
            <Box sx={{ width: '90%', margin: '1rem auto', padding: ' 1rem', backgroundColor: '#fff', borderRadius: '5px', height: '64vh', overflowY: 'auto' }}>
